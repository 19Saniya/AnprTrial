...
cursor = conn.cursor()
cursor.execute('''
    CREATE TABLE IF NOT EXISTS number_plate_trial1c (
...
while True:
    ...
    for (x, y, w, h) in plates:
        ...
        if plate_text:
            ...
            cursor.execute('INSERT INTO number_plate_trial1c (plate_text, capture_time, plate_image) VALUES (?, ?, ?)',
                           (plate_text, capture_time, plate_img.tobytes()))
            conn.commit()
