...
cursor = conn.cursor()
cursor.execute('''
    CREATE TABLE IF NOT EXISTS number_plate_trial4 (
...
def process_frame():
    ...
    for (x, y, w, h) in plates:
        ...
        if plate_text:
            ...
            cursor.execute('INSERT INTO number_plate_trial4 (plate_text, capture_time, plate_image) VALUES (?, ?, ?)',
...
def update_plate_list():
    cursor.execute('SELECT * FROM number_plate_trial4')
